...
thumbMainPath = 'E:\MvP\FinalExperimentWithPancreas\Heterogenicity\ReducePatchSize\Patch256By256\';% Primary Patches
featMainPath = 'E:\MvP\FinalExperimentWithPancreas\Heterogenicity\ReducePatchSize\Feats\';% Features of Primary Patches 
...
metSignal = load("E:\MvP\FinalExperimentWithPancreas\Heterogenicity\ReducePatchSize\Feats\Mets\40 II\40 II_111617_40449\40 II_111617_40449.png_allFeats.mat");
...
for k = 3%[1,2,4]%1:length(thumbDir)
    ...
    correspondingMetFeat = metSignal.allFeats;
    correspondingMetFeat = correspondingMetFeat(criteriaSubfeats)';
    setDir = strcat(thumbMainPath,thumbDir(k).name,'\');
    savePath = strcat('E:\MvP\FinalExperimentWithPancreas\Heterogenicity\ReducePatchSize\DistanceMetPatch\',thumbDir(k).name,'\');
